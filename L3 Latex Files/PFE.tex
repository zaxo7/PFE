...
{\hspace{0.15in}\contentslabel{0.13in}.\hspace{0.1in}}% numbered sections formattin
...
{\large}%
{\contentslabel{0.10in}.\hspace{0.25in}}% numbered sections formattin
...
\fancypagestyle{myfancy}{%   
   \fancyhf{}%
   \fancyfoot[C]{\tikz[baseline={(0,0)},anchor=center] \node[label={center:\thepage}]{\includegraphics[scale=.037]{/home/nemo/Documents/S6/PFE/Icon/cloud.png}};}%
   \renewcommand{\headrulewidth}{0pt}%
   \renewcommand{\footrulewidth}{0pt}%
   \fancyhead{}
   \fancyfoot{}
   \fancyfoot[C]{\vspace{-0.25in}\textcolor{Gray}{\Large{Page}}\hspace{0.04in} \large{\thepage}\hspace{0.07in}\large{|}\hspace{0.07in}\large{\pageref{LastPage}}}
}%
\pagestyle{myfancy}
...
\begin{titlepage}
   ...
   \begin{center}
       ...
       \begin{array}{l}
       \centering
           %\includegraphics[width = 2.2in, height = 1.4in]{/home/nemo/Documents/S6/PFE/Images/UnivUMBB.jpg}
       \end{array}
       \hspace{-0.1in}
...
\begin{center}
    ...
    \\}
\end{center}
\addcontentsline{toc}{chapter}{\vspace{-0.12in}\color{Blue}{Remerciement}}
...
\begin{center}
    ...
    \vspace{0.6in}
\end{center}
\addcontentsline{toc}{chapter}{\vspace{-0.12in}\color{Blue}{Résumé}}
...
\begin{center}
    ...
    \vspace{0.6in}
\end{center}
\addcontentsline{toc}{chapter}{\vspace{-0.12in}\color{Blue}{Abstract}}
\begin{changemargin}{0.9cm}{0.9cm}
...
\addcontentsline{toc}{chapter}{\vspace{-0.12in}\color{Blue}{Table des matières}}
\tableofcontents
\clearpage

\addcontentsline{toc}{chapter}{\vspace{-0.12in}\color{Blue}{Liste des figures}}
\listoffigures
\clearpage

\addcontentsline{toc}{chapter}{\vspace{-0.12in}\color{Blue}{Liste des tableaux}}
\listoftables
\clearpage

\addtocontents{lof}{\protect\thispagestyle{myfancy}}
\addtocontents{lot}{\protect\thispagestyle{myfancy}}
\addtocontents{toc}{\protect\thispagestyle{myfancy}}
...
\begin{figure}[h]
\centering
%    \fbox{\includegraphics[width = 7.5in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Planification/Tasks.png}}
\caption{Les Tâches}
\end{figure}
...
\begin{figure}[H]
\centering
%    \fbox{\includegraphics[width = 9in, height = 7.4in, angle = -90]{/home/nemo/Documents/S6/PFE/Planification/Gantt.png}}
...
\begin{figure}[H]
\centering
%    \fbox{\includegraphics[width = 9in, height = 7.4in, angle = -90]{/home/nemo/Documents/S6/PFE/Planification/Network.png}}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 6.6in, height = 4.4in]{/home/nemo/Documents/S6/PFE/Images/Recours.png}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 7in, height = 3.8in]{/home/nemo/Documents/S6/PFE/Images/webDev.jpeg}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 6in, height = 2.7in]{/home/nemo/Documents/S6/PFE/Images/webDevTools.jpg}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 6in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Images/ModeleRecours.png}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 5in, height = 2.7in]{/home/nemo/Documents/S6/PFE/Images/Analyse_Conception.png}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 4in, height = 2in]{/home/nemo/Documents/S6/PFE/Images/UMLlogo.png}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 3.8in, height = 2.2in]{/home/nemo/Documents/S6/PFE/Images/plantuml.png}
\vspace{-0.1in}
\caption{PlantUML}
\end{figure}
...
\begin{figure}[h]
\centering
    %\fbox{\includegraphics[width = 7in, height = 3in]{/home/nemo/Documents/S6/PFE/Images/PlantumlPreviewer.png}}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 4in, height = 2in]{/home/nemo/Documents/S6/PFE/Images/GraphvizLogo.png}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 3.5in, height = 2in]{/home/nemo/Documents/S6/PFE/Images/Vim.png}
...
\begin{figure}[h]
\centering
    %\includegraphics[width = 2.5in, height = 0.8in]{/home/nemo/Documents/S6/PFE/Images/usecaseEG.png}
...
\end{tabular}
    \caption{Les acteurs, leur cas d'utilisation avec les messages(Émet, Reçu).}
\end{table}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.5in, height = 3.1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Utilisateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.5in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Administrateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 6in, height = 1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Details/GererET.png}}}
...
\rowcolor[HTML]{DAE8FC} 
\textbf{Objectif}                  & \begin{tabular}[c]{@{}l@{}}Donner a l'administration la possibilité d’ajouter des étudiants,\\ supprimer ou modifier un étudiant qui existe déjà.\end{tabular}                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
\rowcolor[HTML]{ECF4FF} 
...
\rowcolor[HTML]{ECF4FF} 
\textbf{Séquencement alternatif}   & \begin{tabular}[c]{@{}l@{}}A1.Si le choix est ajouter:\\   A1.1. Remplir les informations de l'étudiant (nom, prénom …).\\   A1.2. Le système vérifie la validation des information fournis.\\ A2. Si le choix est modifie:\\   A2.1. L’administrateur choisissez l’enseignant qui souhaite modifie.\\   A2.2. Remplissez les champs à modifier.\\ A3. Si le choix est supprimer:\\   A3.1. L’administrateur choisissez l’enseignant qu'il souhaite supprimer.\\   A3.2. Confirmer la suppression de l’enseignant.\end{tabular} \\ \hline
\rowcolor[HTML]{DAE8FC} 
\textbf{Séquencement exceptionnel} & \begin{tabular}[c]{@{}l@{}}Si les informations de l’étudiant ne sont pas correcte,\\ nous générons un message d'erreur. (4).\end{tabular}                                                                                                                                                                                                                                                                                                                                                                                       \\ \hline
\end{tabular}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 8.2in, height = 5in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Enseignant.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 6in, height = 1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Details/GererRecoursSoumis.png}}}
...
\rowcolor[HTML]{DAE8FC}
\textbf{Objectif}                  & \begin{tabular}[c]{@{}l@{}}Rendre disponible pour un enseignant de autoriser ou refuser un recours\\ soumis par un étudiant avec des options supplémentaires!\end{tabular}                                                                                                                                            \\ \hline
\rowcolor[HTML]{ECF4FF}
\textbf{Pré condition}             & Authentification                                                                                                                                                                                                                                                                                                      \\ \hline
\rowcolor[HTML]{DAE8FC}
\textbf{Séquencement nominal}      & \begin{tabular}[c]{@{}l@{}}n1. Lancer l’application web et s’authentifier en tant qu’enseignant.\\ n2. Choisissez un recours à traiter!\\ n3. Traiter le recours en acceptant ou refusant et avec des informations\\ supplémentaire sur le recours!\\ n4. Retourne au page d’accueil.\end{tabular}                    \\ \hline
\rowcolor[HTML]{ECF4FF}
\textbf{Séquencement alternatif}   & \begin{tabular}[c]{@{}l@{}}a1. Si l’enseignant a accepté le recours, il peut choisir de notifier\\ l'étudiant de la nouvelle note ou non! Retourne au (n4).\\ a2. Si l’enseignant a refusé le recours, il peut choisir de donner une\\ explication sur le recours à l'étudiant ou non! Retourne au (n4).\end{tabular} \\ \hline
\rowcolor[HTML]{DAE8FC}
...
\rowcolor[HTML]{ECF4FF}
\textbf{Post condition}            & \begin{tabular}[c]{@{}l@{}}- Notifier l'étudiant de l'état de son recours!\\ - Sauvegarder les changement et toutes les actions entreprises dans un \\ fichier log pour être vu par l’administration.\end{tabular}                                                                                                    \\ \hline
\end{tabular}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 8.2in, height = 5.5in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Etudiant.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 6in, height = 1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Details/AjouterRecours.png}}}
...
\rowcolor[HTML]{DAE8FC}
\textbf{Objectif}                  & \begin{tabular}[c]{@{}l@{}}Donner à l'étudiant la possibilité d'ajouter un recours avec son commentaire\\ sur où se trouve l'erreur et ses informations  (id, année, module, …)!\end{tabular}                                                                                                                                                                                                                                                                          \\ \hline
\rowcolor[HTML]{ECF4FF}
\textbf{Pré condition}             & Authentification                                                                                                                                                                                                                                                                                                                                                                                                                                                  \\ \hline
\rowcolor[HTML]{DAE8FC}
\textbf{Séquencement nominal}      & \begin{tabular}[c]{@{}l@{}}1. Lancer l’application web et s’authentifier en tant qu’étudiant.\\ 2. Remplir les informations (nom, prénom, matricule, année scolaire, …).\\ 3. Choisissez le module et la filière.\\ 4. Ajouter une explication (commentaire) sur l'endroit où le défaut pourrait\\ être (nombre d'exercice ou question …).\\ 5. Ajoutez une photo pour une description détaillée (facultatif).\\ 6. Soumettre le recours.\end{tabular}   \\ \hline
\rowcolor[HTML]{ECF4FF}
    \textbf{Séquencement alternatif}   & \begin{tabular}[c]{@{}l@{}}A1. Si les informations ne correspondent pas a l'étudiant, nous générons\\ un message d'erreur.\end{tabular}                                                                                                                                                                                                                                                                                                                           \\ \hline
\rowcolor[HTML]{DAE8FC}
...
\rowcolor[HTML]{ECF4FF}
\textbf{Post condition}            & \begin{tabular}[c]{@{}l@{}}- Nous devons nous assurer qu'une copie de ce que l'étudiant a entré\\ est enregistrée en temps réel afin de ne pas perdre d'informations\\ (dans la machine de l'utilisateur en tant que fichier temporaire et dans\\ notre base de données si la connexion est bien établie).\\ - Assurer la livraison du recours au enseignant!\\ - Nous voulons nous assurer que l'étudiant est informé de la livraison\\ du recours!\end{tabular} \\ \hline
\end{tabular}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 6in, height = 1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Details/ModifierRecours.png}}}
...
\rowcolor[HTML]{ECF4FF}
\textbf{Séquencement alternatif}   & \begin{tabular}[c]{@{}l@{}}Si les informations ne \\ correspondent pas a l'étudiant,\\ nous générons un message\\ d'erreur.\end{tabular}                                                                                                              \\ \hline
\rowcolor[HTML]{DAE8FC}
\textbf{Séquencement exceptionnel} & \begin{tabular}[c]{@{}l@{}}- En cas ou la connexion ou le\\ serveur n’est pas disponible on\\ actualise la page et retourne\\ l’étudiant a la page d’accueil.\end{tabular}                                                                             \\ \hline
\rowcolor[HTML]{ECF4FF}
\textbf{Post condition}            & \begin{tabular}[c]{@{}l@{}}- Assurer la livraison du nouveau\\ recours (modifié) au enseignant!\\ - Informer l’étudiant que la \\ modification a été effectuée avec\\ succès.\end{tabular}                                                         \\ \hline
\end{tabular}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 6in, height = 1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Details/SupprimerRecours.png}}}
    \vspace{-0.08in}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 6in, height = 1in]{/home/nemo/Documents/S6/PFE/Conception/Usecase/PNG/Details/S'inscrire.png}}}
    \vspace{-0.08in}
...
\begin{figure}[h]
\centering
    %\centerline{\includegraphics[width = 3.5in, height = 2.6in]{/home/nemo/Documents/S6/PFE/Images/DiagSeqEX.png}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.5in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/S'inscrire.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.5in, height = 6.6in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/S'authentifier.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.5in, height = 7.3in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Enseignant/GererRecours.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Etudiant/SelectTousRecours.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Etudiant/AjouterRecours.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Etudiant/ModifierRecours.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Etudiant/SupprimerRecours.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Administrateur/Administrateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Administrateur/AjouterUtilisateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Administrateur/ModifierUtilisateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Sequence/PNG/Administrateur/SupprimerUtilisateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\includegraphics[width = 4.5in, height = 3.7in]{/home/nemo/Documents/S6/PFE/Images/DiagActEX.png}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.4in, height = 7.3in]{/home/nemo/Documents/S6/PFE/Conception/Activity/PNG/Authentification.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.4in, height = 7.3in]{/home/nemo/Documents/S6/PFE/Conception/Activity/PNG/Administrateur.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.4in, height = 7.3in]{/home/nemo/Documents/S6/PFE/Conception/Activity/PNG/Enseignant.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.4in, height = 7.3in]{/home/nemo/Documents/S6/PFE/Conception/Activity/PNG/Etudiant.png}}}
...
\begin{figure}[h]
\centering
    %\centerline{\fbox{\includegraphics[width = 7.5in, height = 4.5in]{/home/nemo/Documents/S6/PFE/Conception/Deployment/PNG/Deployment.png}}}
...
\begin{figure}[h]
\centering
%    \centerline{\fbox{\includegraphics[width = 7.5in, height = 5in]{/home/nemo/Documents/S6/PFE/Conception/Class/PNG/Utilisateur.png}}}
...
\begin{figure}[h]
\centering
%    \centerline{\fbox{\includegraphics[width = 7.5in, height = 5in]{/home/nemo/Documents/S6/PFE/Conception/Class/PNG/Administrateur.png}}}
...
\begin{figure}[h]
\centering
%    \centerline{\fbox{\includegraphics[width = 7.5in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Class/PNG/Enseignant.png}}}
...
\begin{figure}[h]
\centering
%    \centerline{\fbox{\includegraphics[width = 7.4in, height = 6.2in]{/home/nemo/Documents/S6/PFE/Conception/Class/PNG/Etudiant.png}}}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 3.2in, height = 2.4in]{/home/nemo/Documents/S6/PFE/Images/Html.png}
\caption{Logo HTML}
\end{figure}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 2.3in, height = 2.6in]{/home/nemo/Documents/S6/PFE/Images/CSS.png}
\caption{Logo CSS}
\end{figure}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 3.5in, height = 1.3in]{/home/nemo/Documents/S6/PFE/Images/Bootstrap.png}
\vspace{-0.2in}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 2.8in, height = 2.6in]{/home/nemo/Documents/S6/PFE/Images/JS.png}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 2.8in, height = 2.0in]{/home/nemo/Documents/S6/PFE/Images/PHP.png}
\vspace{-0.3in}
\caption{Logo PHP}
\end{figure}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 3.8in, height = 2in]{/home/nemo/Documents/S6/PFE/Images/MySQL.png}
\vspace{0.1in}
\caption{Logo MySQL}
\end{figure}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 3in, height = 2in]{/home/nemo/Documents/S6/PFE/Images/Vim.png}
\vspace{0.0in}
\caption{Logo Vim}
\end{figure}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 6in, height = 2.4in]{/home/nemo/Documents/S6/PFE/Images/mycli.png}
\vspace{-0.1in}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 3.4in, height = 1.3in]{/home/nemo/Documents/S6/PFE/Images/Apache.png}
\caption{Logo Apache}
\end{figure}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 3.4in, height = 2in]{/home/nemo/Documents/S6/PFE/Images/PhpMyAdmin.png}
...
\begin{figure}[h]
\centering
%    \includegraphics[width = 4.0in, height = 4.2in]{/home/nemo/Documents/S6/PFE/Images/MVC.png}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/login.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/register.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/registerFULL.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/registerFULL2.png}}
\caption{Page d'inscription}
\end{figure}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/index.png}}
...
\centering
  \vspace*{-0.4in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.8in]{/home/nemo/Documents/S6/PFE/Site/profileETList.png}}
...
\centering
  \vspace*{0.05in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.5in]{/home/nemo/Documents/S6/PFE/Site/profileETAdd.png}}
...
\centering
  \vspace*{-0.3in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileETUpdate.png}}
...
\centering
  \vspace*{0.05in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileETRead.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.5in]{/home/nemo/Documents/S6/PFE/Site/settings.png}}
\caption{Paramètres}
\end{figure}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5in]{/home/nemo/Documents/S6/PFE/Site/profileENSList.png}}
...
\centering
  \vspace*{-0.3in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileENSRefused.png}}
...
\centering
  \vspace*{0.05in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileENSRead.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.3in]{/home/nemo/Documents/S6/PFE/Site/profileADMList.png}}
...
\centering
  \vspace*{-0.3in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileADMList2.png}}
...
\centering
  \vspace*{0.05in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileADMAdd.png}}
...
\centering
  \vspace*{-0.3in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileADMUpdate.png}}
...
\centering
  \vspace*{0.05in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/profileADMRead.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.3in]{/home/nemo/Documents/S6/PFE/Site/trafic.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/dashboard.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/dashboard2.png}}
...
\centering
  \vspace*{-0.3in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/charts.png}}
...
\centering
  \vspace*{0.05in}
  \hspace*{-0.1in}
%    \fbox{\includegraphics[width = 7.5in, height = 4.6in]{/home/nemo/Documents/S6/PFE/Site/charts2.png}}
...
\centering
  \hspace*{-0.33in}
%    \fbox{\includegraphics[width = 8in, height = 5.2in]{/home/nemo/Documents/S6/PFE/Site/contact.png}}
