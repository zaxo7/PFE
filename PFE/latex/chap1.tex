...
\centering
  \vspace{-0.1in}
    \centerline{\includegraphics[width = 3in, height = 2.4in]{../images/BloodCells.jpg}}
...
\centering
  \vspace{-0.1in}
    \centerline{\fbox{\includegraphics[width = 3in, height = 2.3in]{../images/white_blood_cells.jpg}}}
...
\centering
  \vspace{-0.1in}
    \centerline{\fbox{\includegraphics[width = 3in, height = 2.3in]{../images/platelets.jpg}}}
    \caption{Platelets}
\end{figure}
