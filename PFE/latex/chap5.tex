...
\section{Metrics}
%TODO explain briefly each metric and how it works
\subsection{IOU}
...
%TODO explain briefly each loss function and how it works
%it's always related to the metric for example IOU_Loss is 1 - IOU_Metric samething for all of them
\subsection{BinaryCrossEntrophy}
