...
\vspace{0.25in}
    {\centering\fontsize{30}{40}{\bfseries{\color{Black}{\scshape{Chapter IV : Artificial Intelligence}}}}}
\vspace{0.35in}\\
    {\color{Black} \rule{\linewidth}{1.2mm} }
\end{center}
\vspace*{\fill}
\addcontentsline{toc}{chapter}{\color{Black}{Chapter IV : Artificial Intelligence}}
...
\begin{minipage}{.33\textwidth}
  \centering
  \centerline{\includegraphics[width = 3in, height = 1.8in]{../images/watershed_example.jpg}}
    \subcaption{example Image}
\end{minipage}

\begin{minipage}{.33\textwidth}
  \centering
  \centerline{\includegraphics[width = 3in, height = 1.8in]{../images/watershed_relief.png}}
...
\begin{minipage}{\textwidth}
  \centering
  \centerline{\includegraphics[width = 4in]{../images/Im0001_1_substraction.jpg}}
    \subcaption{example Image}
\end{minipage}

\begin{minipage}{\textwidth}
  \centering
  \centerline{\includegraphics[width = 4in]{../images/Im0001_1_connected_compounent_labeling.jpg}}
