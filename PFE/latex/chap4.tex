...
\begin{minipage}{\textwidth}
  \centering
  \centerline{\includegraphics[width = 5in]{../images/Im0001_1_substraction.jpg}}
    \subcaption{example Image}
\end{minipage}

\begin{minipage}{\textwidth}
  \centering
  \centerline{\includegraphics[width = 5in]{../images/Im0001_1_connected_compounent_labeling.jpg}}
