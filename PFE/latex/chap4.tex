...
\begin{minipage}{.5\textwidth}
  ...
  \subcaption{Output UNet edge}
\end{minipage}
  \caption{Output from SegNet and UNet segmenting Red Blood Cells}
...
\end{minipage}
  \caption{Outputs from SegNet segmenting White Blood Cells}
  \label{fig:cht_output}
\end{figure}
