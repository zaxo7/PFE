...
\begin{minipage}{.33\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.2in]{../images/originalCHT.jpg}}
\end{minipage}%
\begin{minipage}{.33\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.2in]{../images/edgeCHT.jpg}}
\end{minipage}
\begin{minipage}{.33\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.2in]{../images/cht.png}}
\end{minipage}
