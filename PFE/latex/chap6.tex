...
\begin{minipage}{.5\textwidth}
  \centering
  \fbox{\includegraphics[width = 3.2in]{../images/cht.png}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.8in]{../images/originalWatershed.jpg}}
  \subcaption{Original image}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.8in]{../images/watershed_color.jpg}}
...
\begin{minipage}{.5\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.8in]{../images/originalCCL.jpg}}
  \subcaption{Original image}
\end{minipage}%
\begin{minipage}{.5\textwidth}
  \centering
  \fbox{\includegraphics[width = 2.8in]{../images/ccl.png}}
